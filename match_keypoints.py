...
#     # Sort relative to the smallest angle
#     ref_angle = min(angles)
#     return sorted([(angle - ref_angle) % (2 * np.pi) for angle in angles])


# def compute_angular_signature(point_data):
#     """
#     Compute the angular signature using differences relative to the nearest neighbor.
#     """
...
# def estimate_global_rotation(matches):
#     """
#     Estimate the global rotation angle using matched points.
#     """
#     angles1 = []
#     angles2 = []
#     for point1, point2, _, _ in matches:
#         angle1 = np.arctan2(point1[1], point1[0])
#         angle2 = np.arctan2(point2[1], point2[0])
#         angles1.append(angle1)
#         angles2.append(angle2)
#     rotation_differences = [(a1 - a2) % (2 * np.pi) for a1, a2 in zip(angles1, angles2)]
#     return np.mean(rotation_differences)